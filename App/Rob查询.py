...
# jishi = {}
# bcc = get.bcc()
# @bcc.receiver(GroupMessage,dispatchers= [Kanata([FullMatch('2'), RequireParam('parameter')])])
# async def answer(
...
#         await app.sendGroupMessage(group, MessageChain.create([Plain(f'目前被抢最多的小老弟是‘{name1.name}’')]))
#
#
#
